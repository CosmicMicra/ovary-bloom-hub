...
export const Dashboard = () => {
  ...
  const generatePDFReport = () => {
    ...
    doc.text('NOVA - PCOD Care Report', 20, 25);
    ...
    doc.text(`Generated by: NOVA - PCOD Care App`, 20, 75);
    ...
    doc.text('Generated by NOVA - PCOD Care App - Your personalized health companion', 20, 292);
